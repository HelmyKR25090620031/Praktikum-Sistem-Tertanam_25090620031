...
architecture sim of tb_mux8to1 is
    ...
    signal in3_tb : STD_LOGIC_VECTOR(3 downto 0) := "0110"; -- 6
    signal in4_tb : STD_LOGIC_VECTOR(3 downto 0) := "1000"; -- 8
    signal in5_tb : STD_LOGIC_VECTOR(3 downto 0) := "1010"; -- 10
    signal in6_tb : STD_LOGIC_VECTOR(3 downto 0) := "1100"; -- 12
    signal in7_tb : STD_LOGIC_VECTOR(3 downto 0) := "1110"; -- 14
